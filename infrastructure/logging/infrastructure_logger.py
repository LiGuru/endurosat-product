...
class ProgramLogger:
    ...
    def __init__(self, name: str, log_path: object = lg, log_format: object = None, infoLevel: object = None) -> object:
        try:
            if name is None:
            ...
            log_level = self.level_to_int(infoLevel)
